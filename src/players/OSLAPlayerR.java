...
public class OSLAPlayerR extends Player {
    ...
    public OSLAPlayerR(long seed, int id) {
        super(seed, id);
        reset(seed, id);
    }
    ...
    public Types.ACTIONS actSimple(GameState gs) {
        ...
        OSLAPlayerR.Container from_dijkstra = dijkstra(board, myPosition, bombs, enemies, 10);
     ...
     */
    private OSLAPlayerR.Container dijkstra(Types.TILETYPE[][] board, Vector2d myPosition, ArrayList<Bomb> bombs,
        ...
        OSLAPlayerR.Container container = new OSLAPlayerR.Container();
        container.dist = dist;
