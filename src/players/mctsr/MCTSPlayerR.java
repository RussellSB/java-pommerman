...
public class MCTSPlayerR extends ParameterizedPlayer {
    ...
    public MCTSPlayerR(long seed, int id) {
        this(seed, id, new MCTSParamsR());
    }

    public MCTSPlayerR(long seed, int id, MCTSParamsR params) {
    ...
    public void reset(long seed, int playerID) {
        ...
        this.params = (MCTSParamsR) getParameters();
        if (this.params == null) {
            this.params = new MCTSParamsR();
    ...
    @Override
    public Player copy() {
        return new MCTSPlayerR(seed, playerID, params);
    }
}